...
const DashboardGrid = () => {
  return (
    ...
    <div className="row-span-1 col-span-2 flex flex-col gap-4">
      ...
      <div className="border-2 border-dashed border-border rounded-lg p-4 h-44">
    ...
    {/* Profile Completion - 1x1 (top-left) */}
      <div className="border-2 border-dashed border-border rounded-lg p-4 flex flex-col h-44">
      ...
      <div className="row-span-1 col-span-1 border-2 border-dashed border-border rounded-lg p-4 flex flex-col h-44">
        <div className="flex items-center gap-3 mb-4">
