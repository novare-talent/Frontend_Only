      ...
      <div id="tour-job-details">
        <Card className="rounded-2xl">
          <CardContent className="space-y-6">
            ...
            {/* --- BOTTOM OF FORM IN Job-Form.tsx --- */}
<div className="flex items-center gap-3">
  ...
  {/* FIX: Wrapping in a standard div with high z-index and block display.
      This ensures Driver.js sees the element even if the button component 
      swallows the ID prop.
  */}
  <div id="tour-final-submit" className="relative z-50 block">
    <Button
      type="submit"
      className="bg-[#7c3aed] text-primary-foreground hover:bg-[#6d28d9] px-8"
    >
      Create Job
    </Button>
  </div>
      ...
      {/* Live Preview - MODIFIED: Added id="tour-form-preview" */}
      <div className="space-y-3" id="tour-form-preview">
