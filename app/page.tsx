...
//                     <Image src="/Image/novera_talent_logo2.jpg" alt="Novare Talent Logo" class="h-10 w-10 object-contain">
...
//                             <Image src="/Image/Sahil.png" alt="Sahil Sheoran, Founder & CEO" class="w-40 h-40 rounded-full mx-auto mb-4 object-cover border-4 border-primary">
...
//                     <div class="w-full md:w-5/12 lg:w-1/3 glass-card rounded-xl p-8 flex flex-col">
//                         <div class="text-center">
//                             <Image src="/Image/Sankalp.png" alt="Sankalp, Creative Head" class="w-40 h-40 rounded-full mx-auto mb-4 object-cover border-4 border-primary">
...
//                     <div class="w-full md:w-5/12 lg:w-1/3 glass-card rounded-xl p-8 flex flex-col">
//                         <div class="text-center">
//                             <Image src="/Image/Sanat.png" alt="Sanat, Tech & Product" class="w-40 h-40 rounded-full mx-auto mb-4 object-cover border-4 border-primary">
...
//                                         <Image src="/Image/Hitesh Sharma pfp.jpeg.jpg" alt="Photo of Hitesh Sharma" class="w-14 h-14 rounded-full object-cover border-2 border-primary/50">
//                                     </div>
//                                 </div>
//                             </div>
//                             <div class="swiper-slide">
...
//                                         <Image src="/Image/aniket deb.jpg" alt="Photo of Aniket Deb" class="w-14 h-14 rounded-full object-cover border-2 border-primary/50">
//                                     </div>
//                                 </div>
//                             </div>
//                             <div class="swiper-slide">
...
//                                         <Image src="/Image/Onkar Borade pfp.jpeg.jpg" alt="Photo of Onkar Borade" class="w-14 h-14 rounded-full object-cover border-2 border-primary/50">
//                                     </div>
//                                 </div>
//                             </div>
//                         </div>
