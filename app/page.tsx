        ...
        <div className="container mx-auto py-4 max-w-7xl">
          ...
          >
            <nav className="flex flex-col space-y-4">
              <a
                href="#process"
                className="text-gray-300 hover:text-primary transition-colors block text-center py-2"
              >
                Process
              </a>
              <a
          ...
          <div className="container mx-auto px-6 text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-tight">
                By the time your next meeting starts, we&lsquo;ve already found
                your next <span className="text-primary">top hire.</span>
              </h1>
              <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-2xl mx-auto">
                We provide invite-only access to pre-vetted talent from premier
                institutes like IITs, BITS, and IIMs. Get candidates with the
                skills and mindset to drive your startup&lsquo;s growth from day
                one.
              </p>
              <a
                href="#contact"
                className="mt-10 inline-block bg-primary text-white font-bold text-lg px-8 py-4 rounded-lg hover:bg-primary-dark transition-transform hover:scale-105"
              >
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="mt-2 text-lg text-gray-400">
                A Clear Path to Your Next Hire
              </p>
            ...
            <div className="flex flex-col items-center gap-y-8">
              <div className="max-w-2xl w-full p-8 rounded-xl text-center glass-card">
                ...
                <p className="text-gray-400">
                  Start by registering your company on our platform. We&lsquo;ll
                  quickly onboard you after verifying your company details to
                  ensure a trusted network.
                </p>
              </div>
              ...
              <div className="w-full max-w-5xl text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-3">
                  We Source Your Candidates
                </h3>
                <p className="text-gray-400 mb-8">
                  Once you share your job description, we use two primary
                  methods to find the perfect fit.
                </p>
                <div className="grid md:grid-cols-2 gap-10">
                  <div className="p-8 rounded-xl text-left glass-card">
                    <h4 className="text-lg font-bold text-primary mb-2">
                      Method A: Assessment-Based
                    </h4>
                    <p className="text-gray-400">
                      We circulate the job description across our exclusive
                      candidate network, conduct initial assessments, and screen
                      for the top talent.
                    </p>
                  </div>
                  <div className="p-8 rounded-xl text-left glass-card">
                    <h4 className="text-lg font-bold text-primary mb-2">
                      Method B: Referral-Based
                    </h4>
                    <p className="text-gray-400">
                      We leverage trusted references from within our network,
                      providing you with candidates who come with an additional
                      layer of trust and relevance.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-2xl w-full p-8 rounded-xl text-center glass-card">
                ...
                <p className="text-gray-400">
                  You receive a shortlist of 3-4 pre-screened candidates. From
                  there, you can conduct further interviews (managerial,
                  technical) or proceed directly to onboarding your next team
                  member.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-wrap justify-center items-stretch gap-10">
              <div className="w-full md:w-5/12 lg:w-1/3 glass-card rounded-xl p-8 flex flex-col">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-gray-400 text-sm text-left">
                    Sahil is a first-time founder with a simple belief:
                    India&lsquo;s top talent deserves better pathways, and
                    startups deserve better talent. An IIT Bombay graduate, he
                    combines a builder&lsquo;s mindset with a passion for
                    solving real hiring pain. At Novare Talent, he leads the
                    vision, product, and partnerships — with one goal in mind:
                    help founders hire fast without compromising on trust or
                    quality.
                  </p>
                </div>
              </div>
              <div className="w-full md:w-5/12 lg:w-1/3 glass-card rounded-xl p-8 flex flex-col">
                <div className="text-center">
                  <Image
                    src="/Image/Sankalp.png"
                    alt="Sankalp, Creative Head"
                    className="w-40 h-40 rounded-full mx-auto mb-4 object-cover border-4 border-primary"
                    width={400}
                    height={400}
                  />
                  ...
                  <p className="mt-2 text-gray-400 text-sm text-left">
                    He&lsquo;s here for thinking outside the box, but he usually
                    forgets where the box is. He&lsquo;s the reason why you will
                    find Novare Talent an interesting brand; Not just a pretty
                    one, but also like a story you actually want to be part of.
                  </p>
                </div>
              </div>
              <div className="w-full md:w-5/12 lg:w-1/3 glass-card rounded-xl p-8 flex flex-col">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-gray-400 text-sm text-left">
                    Sanat is an Electrical Engineering student at IIT Bombay who
                    loves building things and solving problems with tech.
                    He&lsquo;s always curious and enjoys figuring out how things
                    work. When he&lsquo;s not busy with projects, you&lsquo;ll
                    probably find him watching anime or playing games.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="swiper testimonials-swiper overflow-hidden">
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="p-8 rounded-xl glass-card flex flex-col justify-between h-full">
                      <p className="text-gray-300 italic text-left">
                        &ldquo;I was looking for a UX intern and came across
                        Sahil from Novare Talent via linkedin, we had a quick
                        chat and I shared my requirements + budget, and within a
                        few days he connected me with an intern which was very
                        helpful, fast and curated! I had to put in almost no
                        time or effort.&ldquo;
                      </p>
                      <div className="mt-6 flex items-center justify-end gap-4">
                        ...
                        <Image
                          src="/Image/Hitesh Sharma pfp.jpeg.jpg"
                          alt="Photo of Hitesh Sharma"
                  ...
                  <div className="swiper-slide">
                    <div className="p-8 rounded-xl glass-card flex flex-col justify-between h-full">
                      <p className="text-gray-300 italic text-left">
                        &ldquo;Novare Talent led by Sahil Sheoran focuses on the
                        right pain point in the complex domain of recruitment
                        specifically for internships. Sahil has built a
                        remarkable network within the major IITs... I wish Sahil
                        and the team at Novare all the very best for the stellar
                        future ahead 🙌🏻&ldquo;
                      </p>
                      <div className="mt-6 flex items-center justify-end gap-4">
                        <div className="text-right">
                          ...
                          <p className="text-sm text-primary">
                            ex-CEO/COO of Bizongo
                          </p>
                        </div>
                        <Image
                          src="/Image/aniket deb.jpg"
                          alt="Photo of Aniket Deb"
                          className="w-14 h-14 rounded-full object-cover border-2 border-primary/50"
                          width={400}
                          height={400}
                        />
                  ...
                  <div className="swiper-slide">
                    <div className="p-8 rounded-xl glass-card flex flex-col justify-between h-full">
                      <p className="text-gray-300 italic text-left">
                        &ldquo;Working with Sahil, and Novare Talent, just made
                        hiring so much easier... If you want fast, thoughtful
                        hiring without the usual headache, definitely recommend
                        Novare Talent.&ldquo;
                      </p>
                      <div className="mt-6 flex items-center justify-end gap-4">
                        <div className="text-right">
                        ...
                        <Image
                          src="/Image/Onkar Borade pfp.jpeg.jpg"
                          alt="Photo of Onkar Borade"
                          className="w-14 h-14 rounded-full object-cover border-2 border-primary/50"
                          width={400}
                          height={400}
                        />
        ...
        <section id="contact" className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="mt-2 text-lg text-gray-400">
                Let&apos;s find the talent that will help you scale. Register
                your startup below.
              </p>
              <div className="mt-4 w-24 h-1 bg-primary mx-auto rounded-full"></div>
            </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  ...
                  <div>
                    <label
                      ...
                      className="block text-sm font-medium text-gray-300"
                    >
                      Which type of role are you hiring for?
                    </label>
                    <input
                      type="text"
                      name="needs"
            ...
            <div className="text-center mt-8">
              <p className="text-gray-400">
                ...
                <a
                  href="mailto:sahil@novaretalent.com"
