...
export default function FileManagerPage() {
  ...
  return (
    <div className="flex min-h-fit w-full items-center justify-center bg-gradient-to-br from-background via-background to-muted/20 p-4">
      <div className="w-full max-w-4xl text-center mt-40">
        ...
        <p className="mb-12 text-lg text-muted-foreground md:text-xl">
          We&apos;re building something amazing! Training courses are on the way.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-xl border bg-card/50 p-6 backdrop-blur-sm">
            ...
            <h3 className="mb-2 font-semibold">Expert-Led Courses</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="rounded-xl border bg-card/50 p-6 backdrop-blur-sm">
            ...
            <h3 className="mb-2 font-semibold">Hands-On Projects</h3>
            <p className="text-sm text-muted-foreground">
          ...
          <div className="rounded-xl border bg-card/50 p-6 backdrop-blur-sm">
            ...
            <h3 className="mb-2 font-semibold">Career Support</h3>
            <p className="text-sm text-muted-foreground">
              Get job-ready with our guidance
            </p>
          </div>
        </div>
